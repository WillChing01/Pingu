...
class Board {
    public:
        ...
        void materialHardUpdate() {materialCounter.setValues(pieces);}
        ...
        void generateCaptures(int numChecks)
        {
            ...
            if (!canPromote && !(pawnAttacks(temp,side) & target)) {temp = 0;}
            while (temp)
            {
                pos = popLSB(temp);
                ...
                while (x) {appendPawnCapture(_nPawns+(int)(side), pos, popLSB(x), false, (bool)(pawnPosBoard & pinned));}

                //promotion by moving forward.
                if (!side) {x = ((pawnPosBoard & RANK_7) << 8) & (~p);}
                else {x = ((pawnPosBoard & RANK_2) >> 8) & (~p);}

                while (x) {appendPawnCapture(_nPawns+(int)(side), pos, popLSB(x), false, (bool)(pawnPosBoard & pinned) || numChecks > 0);}
            }
            ...
            if (!(knightAttacks(temp) & target)) {temp = 0;}
            while (temp)
            {
                pos = popLSB(temp);
            ...
            while (temp)
            {
                ...
                while (x) {appendCapture(_nBishops+(int)(side), pos, popLSB(x), (bool)((1ull << pos) & pinned));}
            }
            ...
            while (temp)
            {
                ...
                while (x) {appendCapture(_nRooks+(int)(side), pos, popLSB(x), (bool)((1ull << pos) & pinned));}
            }
            ...
            while (temp)
            {
                ...
                while (x) {appendCapture(_nQueens+(int)(side), pos, popLSB(x), (bool)((1ull << pos) & pinned));}
            }
        }
        ...
        void generateQuiets(int numChecks)
        {
            ...
            while (temp)
            {
                ...
                while (x) {appendQuiet(_nBishops+(int)(side), pos, popLSB(x), (bool)((1ull << pos) & pinned));}
            }
            ...
            while (temp)
            {
                ...
                while (x) {appendQuiet(_nPawns+(int)(side), pos, popLSB(x), (bool)(pawnPosBoard & pinned));}
            }
            ...
            while (temp)
            {
                ...
                while (x) {appendQuiet(_nRooks+(int)(side), pos, popLSB(x), (bool)((1ull << pos) & pinned));}
            }
            ...
            while (temp)
            {
                ...
                while (x) {appendQuiet(_nQueens+(int)(side), pos, popLSB(x), (bool)((1ull << pos) & pinned));}
            }
        }
        ...
        int evaluateBoard()
        {
            int evalScore = nnue.forward() * (1-2*(int)(side));

            //check for drawish endgame evaluation.
            int numPawns = materialCounter.getCount(_nPawns) + materialCounter.getCount(_nPawns+1);
            if (numPawns <= endgameHashMaxPawns)
            {
                const auto query = endgameHash.find(materialCounter.signature);
                if (query != endgameHash.end()) {evalScore /= query->second;}
            }
